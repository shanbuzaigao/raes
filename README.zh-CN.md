...
**状态：** 早期开发，v0.4.0。在我审核完第一个版本之前，这个仓库保持私有。
...
| [templates/](templates/README.zh-CN.md) | 要填写的文件：计划 memo、纳入标准、codebook、prompt、验证 memo 与配置、项目目录；另有[逐字段的中文填写指南](templates/GUIDE.zh-CN.md) |
